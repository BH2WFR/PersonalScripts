...
PYTHON_CANDIDATES = [
    ...
    r"%ProgramData%\miniconda3\python.exe",
    r"%ProgramData%\anaconda3\python.exe",
]
...
def _resolve_output_dir(arg_value: str | None) -> str:
    ...
    return os.path.join(program_files, "PersonalScripts")
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"  select {FLCyan}{os.path.basename(launcher_path)}{CRst}")
    return 0
